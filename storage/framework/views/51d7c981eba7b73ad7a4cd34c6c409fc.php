...
<?php $__env->startSection('title', 'Virtual Tour - Jelajahi Budaya Toraja'); ?>
...
<div class="container-lg">
        ...
        <div class="scene-grid">
            ...
            <div class="scene-card">
                <div class="scene-thumbnail">
                    <?php if($scene->thumbnail): ?>
                    <img src="<?php echo e(asset('storage/' . $scene->thumbnail)); ?>" alt="<?php echo e($scene->title); ?>">
                    <?php else: ?>
                ...
                <div class="scene-info">
                    <h3 class="scene-title"><?php echo e($scene->title); ?></h3>
                    <p class="scene-description"><?php echo e(Str::limit($scene->description, 80)); ?></p>
                    <a href="<?php echo e(route('tour.show', $scene->id)); ?>" class="scene-button">
                        <i class="fas fa-play"></i>
                        Mulai Tur
                    </a>
                </div>
    ...
    <div class="cta-section">
        ...
        <?php if($scenes->count() > 0): ?>
        <a href="<?php echo e(route('tour.show', $scenes->first()->id)); ?>" class="cta-button">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\virtual-tour\resources\views/tour/index.blade.php ENDPATH**/ ?>